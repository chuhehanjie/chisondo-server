...
import com.chisondo.server.modules.devctrl.service.ActivedDeviceInfoService;
 ...
 */
@RestController
@RequestMapping("/devctrl/activeddeviceinfo")
public class ActivedDeviceInfoController {
	@Autowired
